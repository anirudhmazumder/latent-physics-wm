...
90 episodes x 200 steps on the v3.1 band, seeds 9000..9089 (disjoint from training checks at 7000+ and the report at 5000+). Each controller scored with its own (V, M).
